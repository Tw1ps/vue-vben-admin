import { updateBotApi } from '@/api/st/bot';
...
export const requestDataForUpdate: Search<BotColumns> = reactive({
  offset: 0,
  limit: -1,
  order: null,
  order_field: null,
...
export const updateFields = ref<Array<Field<BotColumnsUpdate>>>([]);
...
export const sendUpdateRequest = async (
  ...
  try {
    await updateBotApi({ keyword: obj, values: values });
