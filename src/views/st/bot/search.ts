...
import { BotColumns } from '@/api/st/model/bot';
...
// 搜索相关
export const requestDataForSearch: Search<BotColumns> = reactive({
  offset: 0,
  limit: 20,
  order: null,
  order_field: null,
...
// 获取数据请求
export const getSourceData = async (v: Search<BotColumns>) => {
