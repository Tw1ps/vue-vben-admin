import { getLicenseApi } from '@/api/st/license';
import { Search } from '@/api/st/model/base';
import { LicenseColumns } from '@/api/st/model/license';
...
// 搜索相关
export const requestDataForSearch: Search<LicenseColumns> = reactive({
  offset: 0,
  limit: 20,
  order: null,
  order_field: null,
...
// 获取数据请求
export const getSourceData = async (v: Search<LicenseColumns>) => {
