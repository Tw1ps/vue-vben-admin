import { updateUserApi } from '@/api/st/user';
...
export const requestDataForUpdate: Search<UserColumns> = reactive({
  offset: 0,
  limit: -1,
  order: null,
  order_field: null,
...
export const updateFields = ref<Array<Field<UserColumnsUpdate>>>([]);
...
export const sendUpdateRequest = async (
  ...
  try {
    await updateUserApi({ keyword: obj, values: values });
