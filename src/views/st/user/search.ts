import { getUserApi } from '@/api/st/user';
import { Search } from '@/api/st/model/base';
import { UserColumns } from '@/api/st/model/user';
...
// 搜索相关
export const requestDataForSearch: Search<UserColumns> = reactive({
  offset: 0,
  limit: 20,
  order: null,
  order_field: null,
...
// 获取数据请求
export const getSourceData = async (v: Search<UserColumns>) => {
